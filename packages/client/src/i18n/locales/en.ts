export default {
  ...
  tunnels: {
    title: 'Tunnels',
    subtitle: 'Expose frontend and backend to the public internet for remote access and debugging.',
    tip: 'Powered by Cloudflare Quick Tunnel. A restart may produce a new public URL.',
    frontendTitle: 'Frontend Tunnel',
    frontendDescription: 'Defaults to local Web UI service (8650)',
    backendTitle: 'Backend Tunnel',
    backendDescription: 'Defaults to Hermes API service (8642)',
    running: 'Running',
    stopped: 'Stopped',
