export default {
  ...
  models: {
    ...
    codexAddAccount: '添加账号',
    codexDeleteConfirm: '确定删除 Codex 账号“{name}”？',
    codexDeleteFailed: '删除 Codex 账号失败',
    codexDeleteSuccess: 'Codex 账号已删除',
    codexDeleteTitle: '删除 Codex 账号',
    codexLoadFailed: '加载 Codex 账号失败',
    codexLoginFailed: 'Codex 登录失败',
    codexManageDesc: '管理 OpenAI Codex 的 ChatGPT OAuth 账号，并切换 Hermes 当前使用的账号。',
    codexManageTitle: 'Codex 账号',
    codexNoAccounts: '暂无 Codex 账号',
    codexNotEnabledHint: '当前 Provider 尚未启用 Codex，请先登录或添加账号。',
    codexPollFailed: '检查 Codex 登录状态失败',
    codexSwitch: '切换',
    codexSwitchFailed: '切换 Codex 账号失败',
    codexSwitchSuccess: 'Codex 账号已切换',
